...
export default function Game({ onClose }) {
  ...
  return (
    <div className="max-h-screen min-w-full overflow-y-auto">
      <div className="fixed inset-0 flex items-center justify-center gap-4 bg-white px-12">
...
const Board = ({ children }) => (
  <div className="mx-auto flex w-72 flex-col gap-6 border py-6">{children}</div>
)
